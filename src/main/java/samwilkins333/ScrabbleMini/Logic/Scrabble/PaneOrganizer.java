...
class PaneOrganizer {
	...
	private void setUpIntroSequence() {
		_leftHalf = new ImageView(ImageHelper.create("Main Theme and GUI/introLeft.jpg"));
		...
		_rightHalf = new ImageView(ImageHelper.create("Main Theme and GUI/introRight.jpg"));
		...
		_background = new ImageView(ImageHelper.create("Main Theme and GUI/intro.jpg"));
		...
		_human = ImageHelper.create("AI/human.png");
		_ai = ImageHelper.create("AI/ai.png");
	...
	private void addAIGraphics() {
		_accept = ImageHelper.create("AI/aiaccept.png");
		_reject = ImageHelper.create("AI/aireject.png");
		_thinking = ImageHelper.create("AI/aithinking.png");
	...
	private void addPostIts() {
		...
		ImageView postItOneViewer = new ImageView(ImageHelper.create("Main Theme and GUI/greenpostit.png"));
		...
		ImageView postItTwoViewer = new ImageView(ImageHelper.create("Main Theme and GUI/bluepostit.png"));
		...
		_playerOneHi = new ImageView(ImageHelper.create("Main Theme and GUI/highlight.png"));
		...
		_playerTwoHi = new ImageView(ImageHelper.create("Main Theme and GUI/highlight.png"));
		...
		ImageView pencilView = new ImageView(ImageHelper.create("Main Theme and GUI/pencil.png"));
		...
		ImageView highlightView = new ImageView(ImageHelper.create("Main Theme and GUI/hi.png"));
	...
	private void addBag() {
		_bagViewer = new ImageView(ImageHelper.create("Main Theme and GUI/bag.png"));
	...
	private void setUpDesk() {
		ImageView _leatherViewer = new ImageView(ImageHelper.create("Main Theme and GUI/leatherframe - Original.png"));
		...
		ImageView deskViewer = new ImageView(ImageHelper.create("Main Theme and GUI/desktop.jpg"));
